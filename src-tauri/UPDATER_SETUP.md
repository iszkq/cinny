...
- The updater `notes` field is filled from the GitHub Release body, so the desktop app's update dialog and About page show the same release notes you publish on GitHub.
