...
- The GitHub Actions workflow now uses `tauri-action` to upload the Windows release assets and a follow-up step to upload the generated updater `latest.json` on `v*` tags.
